...
type ComposeState = {
  visible: boolean;
  beat?: any;
  // v1 launch: 'voice' removed (recorder + upload not shipped).
  type: 'text' | 'photo';
  text: string;
  photoUri?: string;
};
        ...
        <View style={styles.sheetBackdrop}>
          <View style={styles.sheet}>
            ...
            <View style={styles.typeRow}>
              {/* v1 launch: text + photo only. Voice recorder isn't wired yet
                  (expo-av + upload endpoint). Add 'voice' back once the
                  recorder component ships. */}
