...
# Build: docker build -f docker/messaging.Dockerfile -t miamo-messaging .
...
COPY services/messaging/package.json services/messaging/package-lock.json* ./
...
COPY services/messaging/package.json services/messaging/tsconfig.json ./
