...
// expect a code for.
app.post('/api/v1/auth/signup/start', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
app.post('/api/v1/auth/signup/verify', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
app.post('/api/v1/auth/signup/complete', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
app.post('/api/v1/auth/google', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
app.post('/api/v1/auth/apple', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const idToken = String(req.body?.idToken || '');
    if (!idToken) throw new AppError('idToken required', 400, 'VALIDATION_ERROR');
...
app.post('/api/v1/auth/otp/start', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
app.post('/api/v1/auth/otp/verify', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
// ─── Email Verification ────────────────────────────
app.post('/api/v1/auth/email/send-otp', authMiddleware, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const user = await prisma.user.findUnique({ where: { id: req.userId } });
    if (!user) throw new AppError('User not found', 404, 'NOT_FOUND');
...
// ─── Phone Verification ────────────────────────────
app.post('/api/v1/auth/phone/send-otp', authMiddleware, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
