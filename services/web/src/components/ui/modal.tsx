...
export function Modal({ open, onClose, title, children, className = '' }: ModalProps) {
 ...
 {/* click-matrix.md §5 rank 24: every modal inherits this X — one aria-label fixes them all. */}
 <button onClick={onClose} aria-label="Close" className="p-1 rounded-lg hover:bg-miamo-elevated transition-colors">
