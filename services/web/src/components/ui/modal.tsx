    ...
    <Modal open={open} onClose={onClose} title={title}>
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <input
          ...
          className="w-full px-3 py-2.5 rounded-xl bg-miamo-elevated border border-border/30 text-sm text-text-primary placeholder:text-text-muted/50 focus:outline-none focus:ring-2 focus:ring-lavender-400/50"
        />
...
export function Toast({ message, type = 'info', open, onClose }: ToastProps) {
  ...
  const colors = {
    ...
    info: 'bg-lavender-400/10 border-lavender-400/20 text-lavender-400',
  };
