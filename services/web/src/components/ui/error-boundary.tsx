      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-[400px] px-8 py-16 text-center">
          ...
          <div className="relative mb-6">
            <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-red-50 to-rose-50 dark:from-red-950/30 dark:to-rose-950/30 border border-red-200/50 dark:border-red-800/30 flex items-center justify-center shadow-[0_8px_32px_rgba(239,68,68,0.08)]">
              <AlertTriangle className="w-8 h-8 text-red-400" />
            </div>
            <div className="absolute -inset-4 rounded-[28px] bg-red-400/5 dark:bg-red-400/3 animate-pulse-slow" />
          </div>
          ...
          {process.env.NODE_ENV === 'development' && this.state.error && (
            <details className="mt-6 max-w-md text-left">
              ...
              <pre className="mt-2 p-3 rounded-xl bg-gray-50 dark:bg-gray-900 text-xs text-gray-600 dark:text-gray-400 overflow-auto max-h-40 border border-gray-200/50 dark:border-gray-700/50">
