...
export function Skeleton({ className }: SkeletonProps) {
 return (
 <div className={cn('animate-pulse rounded-xl bg-gradient-to-r from-miamo-surface via-miamo-card to-miamo-surface bg-[length:200%_100%] animate-shimmer', className)} />
 );
}
