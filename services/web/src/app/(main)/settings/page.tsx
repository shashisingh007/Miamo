       ...
       <Card className="p-6 md:p-7 bg-miamo-card dark:bg-[#181A1F] border border-border dark:border-[#2A2D34]">
        ...
        {activeSection === 'subscription' && (
         <div className="space-y-4">
          ...
          <div className="space-y-1">
           ...
           {/* click-matrix.md §5 rank 1: Cancel subscription — v1 has no self-serve
               cancel path; route users to /premium where the billing surface
               (and eventually the cancel dialog) lives. */}
           <SettingRow label="Cancel subscription" description="Keep premium until period ends">
            <Button variant="ghost" size="sm" onClick={() => router.push('/premium')} aria-label="Cancel subscription">Cancel</Button>
           </SettingRow>
          </div>
         </div>
        )}
        ...
        {activeSection === 'help' && (
         <div className="space-y-1">
          ...
          {/* click-matrix.md §5 rank 1: What's new + Rate Miamo route to
              coming-soon (an intentional, real page) rather than being dead clicks. */}
          <SettingRow icon={Sparkles} label="What’s new" description="See the latest updates">
           <Button variant="ghost" size="sm" onClick={() => router.push('/coming-soon')} aria-label="What's new — coming soon">View</Button>
          </SettingRow>
          <SettingRow icon={Heart} label="Rate Miamo" description="Help us spread the word">
           <Button variant="ghost" size="sm" onClick={() => router.push('/coming-soon')} aria-label="Rate Miamo — coming soon">Rate</Button>
          </SettingRow>
