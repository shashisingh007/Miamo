      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="relative z-10">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-black text-gray-800 dark:text-white">Stories</h1>
              <p className="text-xs text-gray-400 dark:text-gray-500">Share moments with your matches</p>
            </div>
          </div>
