    ...
    <div className="max-w-3xl mx-auto p-6 space-y-5 pb-24">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-black text-gray-800 dark:text-white tracking-tight">Beats</h1>
            <p className="text-[11px] text-gray-400 dark:text-gray-500 font-medium">Daily connection streaks with your matches</p>
          </div>
        </div>
