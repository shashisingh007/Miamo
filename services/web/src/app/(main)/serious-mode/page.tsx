...
import { useTrackPageView, useTrackScrollDepth, trackClick, trackFilterChange } from '@/hooks/useTrackActivity';
      ...
      <div className="sticky top-0 z-30 bg-white/80 backdrop-blur-xl border-b border-zinc-200/60">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5 flex-1">
            ...
            <div>
              <h1 className="text-base font-bold text-zinc-900 dark:text-white">Date to Marry</h1>
              <p className="text-[10px] text-zinc-400 dark:text-gray-500">Find your life partner</p>
            </div>
          </div>
