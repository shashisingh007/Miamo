...
export function ProfileDetailModal({ profile: p, onClose, onRequestAccess, onCheckCompat }: { profile: any; onClose: () => void; onRequestAccess: (type: string) => void; onCheckCompat: () => void }) {
 ...
 className="bg-miamo-card rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-zinc-200 shadow-2xl"
 onClick={(e: any) => e.stopPropagation()}>
 <div className="sticky top-0 z-10 flex justify-between items-center p-4 bg-miamo-card/90 backdrop-blur-xl border-b border-zinc-100">
