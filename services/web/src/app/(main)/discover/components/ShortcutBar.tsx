        ...
        {visible.map((s) => {
          ...
          return (
            ...
            >
              ...
              {s.kind === 'cat' ? (
                active ? (
                  // click-matrix.md §5 rank 46-60: keyboard-accessible clear.
                  // Was `role="button"` with only onClick — inaccessible to
                  // keyboard-only users. Add tabIndex + Enter/Space handlers.
                  <span
                    role="button"
                    tabIndex={0}
                    ...
                    className="ml-1 inline-flex w-4 h-4 items-center justify-center rounded-full hover:bg-rose-main/15 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-main/40"
                  >
                    <X className="w-3 h-3" />
                  </span>
                ) : (
