...
import { useTrackPageView, useTrackScrollDepth, trackNotificationClick } from '@/hooks/useTrackActivity';
  ...
  return (
    ...
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold flex items-center gap-2 dark:text-white"><Bell className="w-5 h-5 text-lavender-400" /> Notifications</h1>
